...
- Jan: 本地运行大模型并进行AI对话的工具，免费开源, https://jan.ai
- AgentGPT: 在浏览器中组装、配置和部署自主人工智能的开源项目, https://agentgpt.reworkd.ai
- Ollama: 本地运行Llama和其他大语言模型, https://ollama.ai
...
- MiracleVision奇想智能: 美图推出的AI视觉大模型，支持AI图像、设计和视频创作, https://www.miraclevision.com
